...
class _SettingScreenState extends State<SettingScreen> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            buildAccountOption(context, "Deactivate Online Banking", "This action cannot be undone\n"
                "Are you sure?"),
            SizedBox(height: 40),
            Row(
              children: [
            ...
            buildAccountOption(context, "Contact Us", "Bank Of Ceylon,\n"
                ...
                "Fax: +94 11 2321160 \n"
                "Email: boc@boc.lk"),
            buildAccountOption(context, "About Us", "Bank of Ceylon is a state-owned,"
  ...
  GestureDetector buildAccountOption(BuildContext context, String title, String description) {
  ...
  GestureDetector buildDeactivateOption(BuildContext context, String title, String description) {
    return GestureDetector(
      onTap: () {
        showDialog(context: context, builder: (BuildContext context) {
          return AlertDialog(
